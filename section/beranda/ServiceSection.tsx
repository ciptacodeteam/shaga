...
export default function ServicesSection() {
  ...
  return (
    <>
      <section>
        <div className='max-w-7xl mx-auto mb-24 md:mb-36 px-4 md:px-6 xl:px-0'>
          ...
          <div className='flex flex-col gap-6 px-4 md:px-0'>
            {services.map((service, index) => (
              <Link key={index} href={'/services'}>
                <div className='group flex items-center justify-between rounded-xl p-5 transition-all duration-300 cursor-pointer bg-white border border-[#E0E6F3] hover:bg-primary hover:text-white'>
